...
>
  <div class="flex-1 px-2 mx-2">
    <a class="text-lg font-bold" href="/"> Maycon Silva </a>
  </div>
  ...
  <div class="dropdown dropdown-left lg:hidden">
    ...
    >
      <a class="btn btn-ghost btn-sm rounded-btn" href="/projetos">
        Portfólio
      </a>
      <!-- <a class="btn btn-ghost btn-sm rounded-btn" href="/posts">
        Posts
      </a> -->
      <a class="btn btn-ghost btn-sm rounded-btn" href="/sobre">
        Sobre mim
      </a>
    </ul>
  </div>
